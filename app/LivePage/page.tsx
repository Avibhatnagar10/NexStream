...
const StreamforgeLanding = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 items-center justify-center h-screen hide-scrollbar  text-white">
      <Navbar/>
