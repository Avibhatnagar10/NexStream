  ...
  return (
    <nav className=" flex justify-between items-center p-4">
      ...
      <div className="flex items-center space-x-6">
        <button
          className="text-sm font-medium text-white bg-transparent px-5 py-3 rounded-md hover:bg-gray-700 hover:bg-opacity-50 hover:border-gray-700 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-500"
        ...
        {user ? (
          <div className="relative" ref={dropdownRef}>
            ...
            <div
              className={`absolute right-0 mt-2 w-48 bg-opacity-90 bg-gray-800 border border-gray-700 shadow-lg rounded-md transition-all duration-500 ease-in-out transform origin-top ${dropdownOpen
